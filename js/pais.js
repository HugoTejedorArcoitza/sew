class Pais {
    // Quitamos el símbolo # para que los campos sean públicos
    nombre;
    capital;
    circuitoF1;
    poblacion;
    ...
    mostrarCoordenadasMeta() {
        const contenedor = document.getElementById('coordenadas-meta');
        if (contenedor) {
            contenedor.innerHTML = `
                <p>Coordenadas del Circuito: Latitud ${this.coordenadas.latitud}, Longitud ${this.coordenadas.longitud}</p>
            `;
        } else {
            console.error("No se encontró un elemento con el id 'coordenadas-meta' en el documento HTML.");
        }
    }
}
